...
| :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                                          [![Image from Gyazo](https://i.gyazo.com/597ab9a043d3f14abca9b53d6ce8d241.gif)](https://gyazo.com/597ab9a043d3f14abca9b53d6ce8d241)                                                          |
...
|                                                                                                                                            レコメンドの生成                                                                                                                                             |
| :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
|                                                                                   [![Image from Gyazo](https://i.gyazo.com/44d9cf73a12f69cf7af74bb0d6235762.gif)](https://gyazo.com/44d9cf73a12f69cf7af74bb0d6235762)                                                                                   |
| <p align="left">リストの詳細画面でレコメンド楽曲の取得ボタンを押すと、リスト内の情報からジャンルの分析や関連アーティスト情報の取得が行われ、それを元にしてレコメンドが生成・取得されます。<br>レコメンド楽曲が取得されると、再生ページに遷移します。再生ページには楽曲のレーティング機能があります。<p> |
